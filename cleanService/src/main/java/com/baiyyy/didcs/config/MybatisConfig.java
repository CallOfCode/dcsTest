...
public class MybatisConfig implements EnvironmentAware {
    ...
    public SqlSessionFactory sqlSessionFactoryBean(DataSource dataSource) {
        ...
        /**设置mapper包扫描路径*/
        if(StringUtils.isNotBlank(mapperXmlLocation)){
            //添加XML目录
            ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
            try {
                bean.setMapperLocations(resolver.getResources(mapperXmlLocation));
            } catch (IOException e) {
                e.printStackTrace();
            }
        }
    ...
    public void setEnvironment(Environment environment) {
        ...
        this.mapperXmlLocation = propertyResolver.getProperty("mybatis.mapperXmlLocation");
        this.configLocation = propertyResolver.getProperty("mybatis.configLocation");
    }
