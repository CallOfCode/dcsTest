 ...
 */
@Service
public class PerfectionCheckServiceInvoker extends AbstractStageServiceInvoker implements IStageServiceInvoker {
    private Logger logger = LoggerFactory.getLogger(PerfectionCheckServiceInvoker.class);
    @Autowired
